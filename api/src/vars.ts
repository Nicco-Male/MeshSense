...
export let automaticTraceroutesMaxHops = new State<number>('automaticTraceroutesMaxHops', 99, { persist: true })
export let favoriteNodesByMyNode = new State<Record<string, number[]>>('favoriteNodesByMyNode', {}, { persist: true })
